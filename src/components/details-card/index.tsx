          ...
          {loading || !profile ? (
            ...
            <Fragment>
              ...
              {social?.website && (
                <ListItem
                  icon={
                    social.website.includes('drive.google.com') ? (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
                    ) : (
                      <FaGlobe />
                    )
                  }
